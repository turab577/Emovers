...
const AdminTable = ({
  ...
  const columns: Column[] = [
  {
    ...
    onLinkClick: openDetail  // Fixed: remove the arrow function wrapper
  },
  ...
  const getDeleteMessage = () => {
    ...
    if (count === 1) {
      return "Are you sure you want to delete this Admin? This action will permanently remove all related data.";
    }
    return `Are you sure you want to delete ${count} Admins? This action will permanently remove all related data.`;
  };
      ...
      <ConfirmationModal
        ...
        title={
          selectedLeadsToDelete.length === 1
            ? "Delete this Admin?"
            : `Delete ${selectedLeadsToDelete.length} Admins?`
        }

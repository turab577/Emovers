...
import DetailDrawer from "./AddLocationDrawer";
...
const LocationsTable = ({
  ...
  const getDeleteMessage = () => {
    ...
    if (count === 1) {
      return "Are you sure you want to delete this Location? This action will permanently remove all related data.";
    }
    return `Are you sure you want to delete ${count} Locations? This action will permanently remove all related data.`;
  };
      ...
      <ConfirmationModal
        ...
        title={
          selectedLeadsToDelete.length === 1
            ...
            : `Delete ${selectedLeadsToDelete.length} Locations?`
        }
